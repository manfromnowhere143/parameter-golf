"""
Depth Recurrence submission for Parameter Golf (track: 10min / 16MB).
...
unique-layer networks at the same parameter count.
"""
...
# HYPERPARAMETERS
# -----------------------------
# Depth Recurrence run:
# - 4 unique transformer blocks repeated 6× = 24 effective layers
